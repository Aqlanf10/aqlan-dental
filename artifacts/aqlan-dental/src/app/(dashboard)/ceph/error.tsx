...
export default function CephError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("التحليل السيفالومتري error:", error);
  }, [error]);
  ...
  return (
    ...
    >
      ...
      <p className="max-w-md text-sm text-gray-500">
        تعذّر تحميل التحليل السيفالومتري. يرجى إعادة المحاولة أو التواصل مع الدعم إذا استمرت المشكلة.
      </p>
      <button
        onClick={reset}
