    ...
    : IFinanceService
{
    ...
    public async Task<ContractDetailDto> CreateContractAsync(CreateContractRequest req)
    {
        var contract = new Contract
        {
            ...
            StartDate = req.StartDate != null ? DateOnly.Parse(req.StartDate) : DateOnly.FromDateTime(ClinicTimeProvider.ClinicToday()),
    ...
    public async Task<PaymentDto> CreatePaymentAsync(CreatePaymentRequest req)
    {
        ...
        try
        {
            ...
            payment = new Payment
            {
                ...
                Amount = req.Amount,
                PaymentDate = DateOnly.FromDateTime(ClinicTimeProvider.ClinicToday()),
