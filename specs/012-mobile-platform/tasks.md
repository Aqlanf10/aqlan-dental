...
- [x] MOBILE-TASK-001 — inventory existing staff mobile and patient portal owners.
- [x] MOBILE-TASK-002 — define separate client/auth/data boundaries.
- [x] MOBILE-TASK-003 — add explicit patient-native auth aliases without changing browser cookie behavior.
