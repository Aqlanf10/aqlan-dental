          ...
          {submitted ? (
            <div className="space-y-4">
              ...
              >
                ...
                <span>إذا كان الحساب موجوداً ومرتبطاً ببريد إلكتروني، سيتم إرسال رابط استعادة كلمة المرور إلى البريد المسجل. الرابط صالح لمدة 30 دقيقة.</span>
              </div>
              <div
              ...
              >
                لم تستلم الإيميل؟ تأكد من تسجيل بريدك الإلكتروني في حسابك. إذا لم يكن لديك بريد مسجل، سيتم إنشاء طلب استعادة يراجعه المدير.
              </div>
              <Link
                href="/login"
