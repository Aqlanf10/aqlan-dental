...
الترقيم التالي بعد `20260630000000` → **ابدأ من `20260631000000`**. كل هجرة: سمة `[Migration]` + ملف Designer + تحديث snapshot
...
### تسلسل الشرائح المرجعي (من «Case presentation Allysa .pptx» — 43 شريحة، 108 صورة)
