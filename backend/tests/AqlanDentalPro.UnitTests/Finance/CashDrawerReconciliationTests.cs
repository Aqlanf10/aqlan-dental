...
public class CashDrawerReconciliationTests
{
    ...
    public async Task FinanceService_CreatePayment_WithNullBranchId_Throws()
    {
        ...
        var service = new FinanceService(db, currentUserNoBranch.Object, notifications.Object, logger.Object, commissionService.Object);
    ...
    public async Task FinanceService_RefundPayment_WithEmptyBranchId_Throws()
    {
        ...
        var service = new FinanceService(db, currentUserEmptyBranch.Object, notifications.Object, logger.Object, commissionService.Object);
