...
export const VISIT_TYPE_RULES: VisitTypeRule[] = [
  ...
  // Phase 1 ortho integration: detailed orthodontic visit types
  rule("ortho_bonding", "تركيب بندات التقويم", ["Bonding", "OrthoBonding", "Bracket Bonding", "تركيب بندات"], true, true, false, true, true, true, 60),
  rule("ortho_adjustment", "تعديل التقويم", ["Adjustment", "OrthoAdjustment", "Wire Change", "تعديل التقويم"], true, false, false, true, true, true, 20),
  rule("ortho_debonding", "فك بندات التقويم", ["Debonding", "OrthoDebonding", "فك بندات"], true, true, false, true, true, true, 45),
  rule("retainer_delivery", "تسليم مثبت", ["RetainerDelivery", "Retainer Delivery", "تسليم مثبت"], false, true, true, true, true, true, 20),
  rule("ortho_records", "أخذ سجلات تقويمية", ["OrthoRecords", "Orthodontic Records", "سجلات تقويمية"], false, true, true, false, true, true, 30),
  rule("ortho_emergency", "طوارئ تقويم", ["OrthoEmergency", "Ortho Emergency", "طوارئ تقويم"], false, true, true, true, true, true, 20),
  rule("retention_follow_up", "متابعة احتفاظ", ["RetentionFollowUp", "Retention Follow-up", "متابعة احتفاظ", "متابعة مثبت"], false, false, true, true, true, true, 15),
