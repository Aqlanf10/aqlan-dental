...
/// Shares the same constructor, db context, and helpers (GetUnbilledVisitsAmountAsync,
/// GetOverdueContractsAsync, MapPayment, NormalizeCurrency) as the main partial.
/// </summary>
