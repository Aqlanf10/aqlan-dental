...
- **هوية التقارير (قرار المالك):** كل تقرير/PDF/عرض حالة يحمل اسم المركز كاملًا + «د. عقلان الكامل — أخصائي تقويم الأسنان» (الافتراضي في تقارير التقويم والسيفالو) + بيانات التواصل في التذييل — تُقرأ من جدول Settings لا hardcoding.
