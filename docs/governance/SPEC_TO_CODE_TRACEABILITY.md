...
| `CEPH-REQ-029` | Cephalometry advanced evaluation | Shared geometry, derived measurements, repeatability, confidence, comparator deltas | `docs/ceph-ai/CEPH_AI_VALIDATION_PROTOCOL.md`; implementation queued | parity/statistics/clinical fixtures required | queued as SEQ-55 | 2026-07-14 | Critical |
