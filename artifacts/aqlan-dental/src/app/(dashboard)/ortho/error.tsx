...
export default function OrthoError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("وحدة التقويم error:", error);
  }, [error]);
  ...
  return (
    ...
    >
      ...
      <p className="max-w-md text-sm text-gray-500">
        تعذّر تحميل وحدة التقويم. يرجى إعادة المحاولة أو التواصل مع الدعم إذا استمرت المشكلة.
      </p>
      <button
        onClick={reset}
