...
public class FinanceAccountStatementTests
{
    ...
    // TD-021 PR A2: GetAccountStatementAsync moved from FinanceService to FinanceReadService.
    // All tests in this file exercise read-only logic, so CreateService now returns
    // FinanceReadService directly.
    private static FinanceReadService CreateService(AppDbContext db)
    {
        ...
        return new FinanceReadService(db, currentUser.Object);
    }
