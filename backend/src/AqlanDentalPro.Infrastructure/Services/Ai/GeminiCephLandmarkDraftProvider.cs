    ...
    IHttpClientFactory httpClientFactory) : ICephLandmarkDraftProvider
{
            ...
            contents = new[]
            {
                new
                {
                    ...
                    parts = new object[]
                    {
                        ...
                        new { text = BuildPrompt(precision) },
                    },
                },
            },
    ...
    public async Task<CephAiLandmarkPoint?> RefineAsync(
        ...
        CancellationToken cancellationToken)
    {
        if (!AllowedKeys.Contains(target.Key))
            ...
            contents = new[]
            {
                new
                {
                    ...
                    parts = new object[]
                    {
                        ...
                        new { text = BuildRefinePrompt(target) },
                    },
                },
            },
            generationConfig = new
    ...
    private static string BuildPrompt(CephAiPrecision precision) =>
        $$"""
    ...
    private static string BuildRefinePrompt(CephLandmarkRefineTarget target) =>
        $$"""
