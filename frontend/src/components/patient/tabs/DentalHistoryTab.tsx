      ...
      <div className="space-y-4" dir="rtl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="md:col-span-2">
            ...
            <textarea value={form.chiefComplaint ?? ""} onChange={(e) => setForm({ ...form, chiefComplaint: e.target.value })} className="w-full text-sm border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-clinic-blue" rows={2} />
          </div>
          <div className="md:col-span-2">
            <label className="text-xs text-gray-500 block mb-1">العلاجات السابقة</label>
            <textarea value={form.previousTreatments ?? ""} onChange={(e) => setForm({ ...form, previousTreatments: e.target.value })} className="w-full text-sm border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-clinic-blue" rows={2} />
          </div>
