      ...
      <footer id="contact" dir="rtl" style={{ backgroundColor: "#0F172A" }} className="text-slate-400">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-4 text-sm">
              <div className="flex items-start gap-2.5 text-slate-400">
                ...
                <div>
                  <div className="text-white font-semibold">السبت – الخميس</div>
                  <div>8:00 ص – 8:00 م</div>
                </div>
              </div>
              <div className="flex items-center gap-2.5">
        ...
        <div className="max-w-7xl mx-auto px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="text-xs text-slate-600 text-center sm:text-right">
            © {new Date().getFullYear()} مركز الدكتور عقلان الكامل لتقويم وزراعة وتجميل الأسنان. جميع الحقوق محفوظة.
          </div>
          <Link
            href="/home/book"
